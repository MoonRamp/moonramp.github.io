      ...
      <Grid sx={{padding: 6}} container rowSpacing={8} columnSpacing={1}>
          ...
          <Stack spacing={10}>
            <Box pl={5}>
              <Typography variant="h3">
                Accept Crypto Payments with No Fees & No Third-Party
              </Typography>
            </Box>
            <Container>
        ...
        <Grid item xs={12} md={6}>
          <Bounce>
            <FadeCarousel>
              <QrCode
                data="https://moonramp.github.io?ticker=btc"
                image={bitcoinUrl}
                cornersSquareColor="#F99400"
              ></QrCode>
              <QrCode
                data="https://moonramp.github.io?ticker=bch"
                image={bitcoinCashUrl}
                cornersSquareColor="#2FCF6E"
              ></QrCode>
              <QrCode
                data="https://moonramp.github.io?ticker=xmr"
                image={moneroUrl}
                cornersSquareColor="#FF6600"
              ></QrCode>
              <QrCode
                data="https://moonramp.github.io?ticker=eth"
                image={ethereumUrl}
                cornersSquareColor="#454A75"
              ></QrCode>
              <QrCode
                data="https://moonramp.github.io?ticker=etc"
                image={ethereumClassicUrl}
                cornersSquareColor="#3AB83A"
              ></QrCode>
            </FadeCarousel>
          </Bounce>
        </Grid>
        ...
        <Grid item xs={12} md={2}>
          <CryptoGridCircle image={bitcoinUrl} blankImage={bitcoinBlankUrl} ticker="BTC" />
        </Grid>
        <Grid item xs="none" md={2}></Grid>
        <Grid item xs={12} md={2}>
          <CryptoGridCircle image={moneroUrl} blankImage={moneroBlankUrl} ticker="XMR" />
        </Grid>
        <Grid item xs="none" md={2}></Grid>
        <Grid item xs={12} md={2}>
          <CryptoGridCircle image={bitcoinCashUrl} blankImage={bitcoinCashBlankUrl} ticker="BCH" />
        </Grid>
        <Grid item xs="none" md={1}></Grid>
        ...
        <Grid item xs="none" md={2}></Grid>
        <Grid item xs={12} md={2}>
          <CryptoGridCircle image={ethereumUrl} blankImage={ethereumBlankUrl} ticker="ETH" />
        </Grid>
        <Grid item xs="none" md={2}></Grid>
        <Grid item xs="none" md={1}></Grid>
